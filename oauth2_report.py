...
number_of_power_test_iterations = 100
number_of_memory_test_iterations = 1
number_of_cpu_test_iterations = 20
number_of_time_test_iterations = 100
...
def run_memory_tests(client):
    ...
    print("Average memory consumption over", number_of_memory_test_iterations, "tests for connecting:",
          "%.4f" % average_connection_memory_MB, "MB")
    print("Average memory consumption over", number_of_memory_test_iterations, "tests for receiving file:",
...
def run_cpu_utilization_tests(client):
    ...
    print("Average CPU usage over", number_of_cpu_test_iterations, "tests for connecting:",
          "%.4f" % (np.average(cpu_percents_connect) / psutil.cpu_count()))
    print("Average CPU usage over", number_of_cpu_test_iterations, "tests for receiving file:",
          "%.4f" % (np.average(cpu_percents_receive_file) / psutil.cpu_count()))
    print()
    print("Max CPU usage over", number_of_cpu_test_iterations, "tests for connecting:",
          "%.4f" % (max(cpu_percents_connect) / psutil.cpu_count()))
    print("Max CPU usage over", number_of_cpu_test_iterations, "tests for receiving file:",
          "%.4f" % (max(cpu_percents_receive_file) / psutil.cpu_count()))
